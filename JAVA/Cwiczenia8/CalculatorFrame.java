...
public class CalculatorFrame extends javax.swing.JFrame {
	...
	//limit dlugosci cyfr liczby to 16
	
	//
	//
	// Stringi przechowujace znaki klawiszy
	//
    ...
    //Stringi do obslugi ciagow znakow wyswietlanych na kontenerach
    ...
    private void initComponents() {
        ...
        btnNoqte.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        btnNoqte.setText(".");
        ...
        btnCem.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        btnCem.setText("+");
        ...
        btnCix.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        btnCix.setText("-");
        ...
        btnVur.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        btnVur.setText("*");
        ...
        btnBol.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        btnBol.setText("/");
        ...
        btnKok.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        btnKok.setText("√");
        ...
        btnKvadrat.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        ...
        //kolor tla
        tfCalculator.setBackground(new java.awt.Color(0, 153, 0));
        
        
        
        
        tfCalculator.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        ...
        lblCalculator.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
    ...
    private void btnSixActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        //maksymalna dlugosc dzialania to 16
    	if (text.length() <= 16) {
            ...
            JOptionPane.showMessageDialog(this, "limit dlugosci cyfr liczby to 16");
    ...
    private void btnKvadratActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void btnCemActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void btnCixActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void btnVurActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    String kokResult = "";
    private void btnKokActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void btnNoqteActionPerformed(java.awt.event.ActionEvent evt) {
        if (text.length() <= 16) {
